...
class _SignupPageState extends ConsumerState<SignupPage> {
  ...
  Future<void> _signup() async {
    ...
    try {
      ...
      // NO manual navigation. RootRouter will route the user (first-time -> profile).
    } catch (e) {
        ...
        child: SingleChildScrollView(
          ...
          child: Form(
            ...
            child: Column(children: [
              ...
              TextFormField(controller: pass, obscureText: true, decoration: const InputDecoration(hintText: 'Password', prefixIcon: Icon(Icons.lock_outline), border: OutlineInputBorder(borderRadius: BorderRadius.all(Radius.circular(12)))), validator: (v) => v!.length < 6 ? 'Minimum 6 characters' : null),
              ...
              ElevatedButton(
                ...
                child: loading ? const CircularProgressIndicator(color: Colors.white) : const Text('Sign Up', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
              )
            ]),
          ),
        ),
