...
class _LoginPageState extends ConsumerState<LoginPage> {
  ...
  Future<void> _loginEmail() async {
    ...
    try {
      ...
      // on success: check if user has farm profile inside FarmProfilePage or navigate to FarmProfilePage
  ...
  Future<void> _google() async {
    setState(() => loading = true);
    try {
      final cred = await ref.read(authRepositoryProvider).googleSignIn();
      if (cred != null) {
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(builder: (_) => const FarmProfilePage()),
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              ), // language button (same as before) — you can reuse your previous widget
              ...
              const Text(
                "Manage your farm's biosecurity with ease.",
